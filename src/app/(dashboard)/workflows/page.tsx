...
const WORKFLOWS: Workflow[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "FlowOps AI carga el skill advisory-board/SKILL.md",
  ...
  },
  {
    ...
    status: "active",
    steps: [
      "Comprueba si hay cambios en el workspace de FlowOps AI",
  ...
  },
  {
    ...
    description: "Sesión autónoma nocturna que implementa mejoras en FlowOps AI según el ROADMAP o inventa features nuevas útiles.",
    schedule: "3h (cada noche)",
    trigger: "cron",
    status: "active",
    steps: [
      "Lee ROADMAP.md de FlowOps AI para seleccionar la siguiente feature",
